        ...
        <ul class="nav nav-tabs" id="tabs">
            <li class="active">
                <a data-toggle="tab" href="#tab-1" aria-expanded="false">
                    Cadastro de Colaboradores Inicial
                </a>
            </li>
            <!-- <li class="nav-item">
                                        ...
                                        <div style="border: none; " class="col-md-12">
                                            <div class="row col">
                                                <div style="margin-left: 80px; margin-bottom: 40px;" class="form-group col-sm-12 col">
                                                    <center>
                                                        <h3>Upload de colaboradores (Inicial)</h3>
                                                    </center>
...
<script language="JavaScript">
    ...
    function func_upload() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: '../mod_rh/lib/lib_upload_colaboradores.php',
                    type: 'post',
                    data: formData,
                    contentType: false,
                    processData: false,
    ...
    function func_carrega_tab() {
        ...
        $.ajax({
            type: "POST",
            url: "lib/lib_log_upload_colaboradores.php",
            data: {
                "v_acao": v_acao
