            ...
            <div class="box-body" style="height: auto;">
                <div class="row">
                    ...
                    <div class="form-group col-sm-11">
                        <label for="c_nome_cargo">Nome</label>
                        <input id="c_nome_cargo" type="text" class="form-control class_inputs" placeholder="Cargo">
                    </div>
                </div>
                <div class="row">
...
<script language="JavaScript">
    ...
    function func_carrega_tab() {
        ...
        $("#c_nome_cargo").prop("disabled", false);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (v_index = 1; v_index < data.length; v_index++) {
                    options += '<tr  style="cursor: pointer;" onclick="func_select(\'' + data[v_index].Id + '\');"><td>' + data[v_index].Id + '</td><td>' + data[v_index].Cargo + '</td><td>';
                }
                $('#tab1b').html(options);
