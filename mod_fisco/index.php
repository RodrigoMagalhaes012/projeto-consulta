...
if (strpos($_SESSION["vs_array_access"], "M0003") == 0) {
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li <?php if (strpos($_SESSION["vs_array_access"], "T0039") == 0) {
                      print('style="display: none;');
                    } ?>><a><i class="fa fa-file-text"></i> NFe <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <?php if (strpos($_SESSION["vs_array_access"], "T0003") > 0) {
                      print('<li><a onclick="$(\'#c_select_empresa\').hide(); $(\'#div_tela\').load(\'danfe_cons_entrada.php\');">Danfes de Entrada</a></li>');
                    } ?>
                    <?php if (strpos($_SESSION["vs_array_access"], "T0004") > 0) {
                      print('<li><a onclick="$(\'#c_select_empresa\').hide(); $(\'#div_tela\').load(\'danfe_cons_saida.php\');">Danfes de Saída</a></li>');
                    } ?>
                  </ul>
                </li>
                ...
                <?php if (strpos($_SESSION["vs_array_access"], "T0001") > 0) {
                  $mc = new MyCripty();
                  print('<li>');
                  print('<a onclick="window.open(\'../chat/index_user.php?chave1=' . $mc->enc($_SESSION["vs_id"]) . "&chave2=" . $mc->enc($_SESSION["vs_nome"]) . "&chave3=" . $mc->enc($_SESSION["vs_db_empresa"]) . '\', \'_blank\');"><i class="fa fa-comments"></i> Prestar suporte via CHAT </a>');
                  print('</li>');
                } ?>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                ...
                <ul class="dropdown-menu dropdown-usermenu pull-right">
                  ...
                  <li><a href="https://unifica.agrocontar.com.br/ajuda_menu.php" target="_blank">Ajuda</a></li>
      ...
      <div class="fab">
        ...
        <ul>
          ...
          <li>
            ...
            <button id="opcao2" onclick="window.open('https://app.agrocontar.com.br/ajuda_menu.php', '_blank');">
