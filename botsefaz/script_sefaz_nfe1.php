...
if ($v_acao == "START_SCRIPT") {
  ...
  if ($cod_dia_samana == 0 || $cod_dia_samana == 6) {
    ...
    $hora_limite_fim = strtotime("08:00:00");
  } else {
    // VALIDANDO JANELA PARA EXECUÇÃO NOS DIAS ÚTEIS
    $hora_limite_in = strtotime("05:30:00");
    $hora_limite_fim = strtotime("17:00:00");
  }
  ...
  ORDER BY fisco_script_order desc, tipo asc, nome asc";
            ...
            foreach ($array_xml->soapBody->nfeDistDFeInteresseResponse->nfeDistDFeInteresseResult->retDistDFeInt->loteDistDFeInt->docZip as $v_conteudo) {
              ...
              if ($v_schema == "resNFe") {
                ...
                if ($v_nfe_tipo == 1) {
                  ...
                  if ($v_cSitNFe == 1) {
                    $v_sql = "INSERT INTO db_emp_" . $v_db_emp . ".t_fisco_" . $v_nfe_ano . "_nfeProc (chave_01, chave_02, chave_03, nsu, dt_emit, nfe_tipo, cnpj, cnpj_nfe, razao_social_nfe, tipo_pessoa, mod_schema, versao, vnf, xml_nfe, nfe_manifesto) 
                  VALUES ('" . $v_chNFe_01 . "', '" . $v_chNFe_02 . "', '" . $v_chNFe_03 . "', " . $v_nfe_nsu . ", '" . $v_dt_emit . "', " . $v_nfe_tipo . ", " . $v_cnpj_emp . ", " . $v_Cnpj_cpf_emit . ", '" . $v_razao_social_emit . "', '" . $v_chNFe_pessoa_emit . "', '" . $v_schema . "', '" . $v_nfe_versao . "', " . $v_vNF . ", '" . $v_xml . "', 0) 
              ...
              if ($v_schema == "procNFe") {
                ...
                if (array_key_exists((string)$v_Cnpj_cpf_dest, $v_array_empresas)) {
                  ...
                  $v_sql = "INSERT INTO db_emp_" . $v_db_emp_dest . ".t_fisco_" . $v_nfe_ano . "_nfeProc (chave_01, chave_02, chave_03, nsu, dt_emit, nfe_tipo, cnpj, cnpj_nfe, razao_social_nfe, tipo_pessoa, mod_schema, versao, quant_prod, vBC,vICMS,vICMSDeson,vFCP,vBCST,vST,vFCPST,vFCPSTRet,vProd,vFrete,vSeg,vDesc,vII,vIPI,vIPIDevol,vPIS,vCOFINS,vOutro,vNF, xml_nfe, nfe_manifesto) 
                VALUES ('" . $v_chNFe_01 . "', '" . $v_chNFe_02 . "', '" . $v_chNFe_03 . "', " . $v_nfe_nsu . ", '" . $v_dt_emit . "', " . $v_nfe_tipo . ", " . $v_cnpj_emp . ", " . $v_Cnpj_cpf_emit . ", '" . $v_razao_social_emit . "', '" . $v_chNFe_pessoa_emit . "', '" . $v_schema . "', '" . $v_nfe_versao . "', " . $v_quant_prod . ", " . $v_vBC . ", " . $v_vICMS . ", " . $v_vICMSDeson . ", " . $v_vFCP . ", " . $v_vBCST . ", " . $v_vST . ", " . $v_vFCPST . ", " . $v_vFCPSTRet . ", " . $v_vProd . ", " . $v_vFrete . ", " . $v_vSeg . ", " . $v_vDesc . ", " . $v_vII . ", " . $v_vIPI . ", " . $v_vIPIDevol . ", " . $v_vPIS . ", " . $v_vCOFINS . ", " . $v_vOutro . ", " . $v_vNF . ", '" . $v_xml . "', 210210) 
                ON CONFLICT ON CONSTRAINT t_fisco_" . $v_nfe_ano . "_nfeProc_pkey 
                DO NOTHING";
                  pg_query($conn, $v_sql);
                ...
                if (array_key_exists((string)$v_Cnpj_cpf_emit, $v_array_empresas)) {
                  $v_db_emp_emit = $v_array_empresas[(string)$v_Cnpj_cpf_emit];
                  $v_sql = "INSERT INTO db_emp_" . $v_db_emp_emit . ".t_fisco_" . $v_nfe_ano . "_nfeProc (chave_01, chave_02, chave_03, nsu, dt_emit, nfe_tipo, cnpj, cnpj_nfe, razao_social_nfe, tipo_pessoa, mod_schema, versao, quant_prod, vBC,vICMS,vICMSDeson,vFCP,vBCST,vST,vFCPST,vFCPSTRet,vProd,vFrete,vSeg,vDesc,vII,vIPI,vIPIDevol,vPIS,vCOFINS,vOutro,vNF, xml_nfe, nfe_manifesto) 
                VALUES ('" . $v_chNFe_01 . "', '" . $v_chNFe_02 . "', '" . $v_chNFe_03 . "', " . $v_nfe_nsu . ", '" . $v_dt_emit . "', " . $v_nfe_tipo . ", " . $v_cnpj_emp . ", " . $v_Cnpj_cpf_dest . ", '" . $v_razao_social_dest . "', '" . $v_chNFe_pessoa_dest . "', '" . $v_schema . "', '" . $v_nfe_versao . "', " . $v_quant_prod . ", " . $v_vBC . ", " . $v_vICMS . ", " . $v_vICMSDeson . ", " . $v_vFCP . ", " . $v_vBCST . ", " . $v_vST . ", " . $v_vFCPST . ", " . $v_vFCPSTRet . ", " . $v_vProd . ", " . $v_vFrete . ", " . $v_vSeg . ", " . $v_vDesc . ", " . $v_vII . ", " . $v_vIPI . ", " . $v_vIPIDevol . ", " . $v_vPIS . ", " . $v_vCOFINS . ", " . $v_vOutro . ", " . $v_vNF . ", '" . $v_xml . "', 210210) 
                ON CONFLICT ON CONSTRAINT t_fisco_" . $v_nfe_ano . "_nfeProc_pkey 
                DO NOTHING";
                  pg_query($conn, $v_sql);
    ...
    where t_fisco_" . $v_ano_atual . "_nfeproc.chave_01 = tab_temp.chave_01 
    ...
    and to_date(to_char(t_fisco_" . $v_ano_atual . "_nfeproc.data_hora, 'YYYY-MM-DD'), 'YYYY-MM-DD') = CURRENT_DATE";
      ...
      where t_fisco_" . $v_ano_passado . "_nfeproc.chave_01 = tab_temp.chave_01 
